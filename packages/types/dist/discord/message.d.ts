...
import type { DiscordAuthorizingIntegrationOwners, DiscordInteractionDataResolved, DiscordMessageInteraction, InteractionTypes } from './interactions.js';
...
export interface DiscordMessage extends Partial<DiscordMessageCreateExtra> {
    ...
    thread?: Omit<DiscordChannel, 'member'> & {
...
export type DiscordMessageInteractionMetadata = DiscordApplicationCommandInteractionMetadata | DiscordMessageComponentInteractionMetadata | DiscordModalSubmitInteractionMetadata;
...
export declare enum DiscordMessageReferenceType {
    /**
...
export interface DiscordMessageSnapshot {
    ...
    message: Pick<DiscordMessage, 'type' | 'content' | 'embeds' | 'attachments' | 'timestamp' | 'edited_timestamp' | 'flags' | 'mentions' | 'mention_roles' | 'stickers' | 'sticker_items' | 'components'>;
}
...
export declare enum DiscordReactionType {
    Normal = 0,
    Burst = 1
}
