...
/** https://discord.com/developers/docs/resources/audit-log#audit-log-entry-object-audit-log-events */
export type DiscordAuditLogChange = DiscordAuditLogChangeObject<DiscordGuild> | DiscordAuditLogChangeObject<DiscordChannel> | DiscordAuditLogChangeObject<DiscordOverwrite> | DiscordAuditLogChangeObject<DiscordMember> | DiscordAuditLogChangePartialRole | DiscordAuditLogChangeObject<DiscordRole> | DiscordAuditLogChangeInvite | DiscordAuditLogChangeInviteMetadata | DiscordAuditLogChangeWebhook | DiscordAuditLogChangeObject<DiscordEmoji> | DiscordAuditLogChangeObject<DiscordIntegration> | DiscordAuditLogChangeObject<DiscordStageInstance> | DiscordAuditLogChangeObject<DiscordSticker> | DiscordAuditLogChangeObject<DiscordScheduledEvent> | DiscordAuditLogChangeObject<DiscordThreadMetadata> | DiscordAuditLogChangeApplicationCommandPermissions | DiscordAuditLogChangeObject<DiscordSoundboardSound> | DiscordAuditLogChangeObject<DiscordAutoModerationRule> | DiscordAuditLogChangeObject<DiscordGuildOnboardingPrompt> | DiscordAuditLogChangeObject<DiscordGuildOnboarding>;
...
export type DiscordAuditLogChangePartialRole = {
    new_value: {
        id: string;
        name: string;
    }[];
 ...
 */
export type DiscordAuditLogChangeInvite = DiscordAuditLogChangeObject<DiscordInvite> | DiscordAuditLogChangeObject<{
    channel_id: string;
}>;
/**
 ...
 * While the docs say that 'channel.id' will never exist, we keep it as it is very complex to remove, the user should not use it and use the provided 'channel_id' value instead
 */
export type DiscordAuditLogChangeInviteMetadata = DiscordAuditLogChangeObject<DiscordInviteMetadata> | DiscordAuditLogChangeObject<{
    channel_id: string;
}>;
/** Webhook audit log entry change exception */
export type DiscordAuditLogChangeWebhook = DiscordAuditLogChangeObject<Omit<DiscordWebhook, 'avatar'>> | DiscordAuditLogChangeObject<{
    avatar_hash: DiscordWebhook['avatar'];
}>;
