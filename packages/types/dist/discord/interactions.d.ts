...
export declare enum DiscordInteractionContextType {
...
export interface DiscordInteractionDataResolved {
     ...
     */
    channels?: Record<string, Pick<DiscordChannel, 'id' | 'name' | 'type' | 'permissions' | 'last_message_id' | 'last_pin_timestamp' | 'nsfw' | 'parent_id' | 'guild_id' | 'flags' | 'rate_limit_per_user' | 'topic' | 'position' | 'thread_metadata'>>;
...
export declare enum DiscordInteractionEntryPointCommandHandlerType {
