...
export interface DiscordSelectMenuComponent extends DiscordBaseComponent {
    type: MessageComponentTypes.StringSelect | MessageComponentTypes.UserSelect | MessageComponentTypes.RoleSelect | MessageComponentTypes.MentionableSelect | MessageComponentTypes.ChannelSelect;
...
export interface DiscordContainerComponent extends DiscordBaseComponent {
    ...
    components: Array<DiscordActionRow | DiscordTextDisplayComponent | DiscordSectionComponent | DiscordMediaGalleryComponent | DiscordSeparatorComponent | DiscordFileComponent>;
