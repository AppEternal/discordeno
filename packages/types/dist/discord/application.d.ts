...
export declare enum DiscordApplicationIntegrationType {
...
export declare enum DiscordApplicationEventWebhookStatus {
...
export declare enum DiscordActivityLocationKind {
