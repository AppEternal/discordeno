...
export declare function transformInteraction(
  bot: Bot,
...
export declare function transformInteractionDataResolved(
  bot: Bot,
...
export declare function transformInteractionCallbackResponse(
  bot: Bot,
...
export declare function transformInteractionResource(
  bot: Bot,
