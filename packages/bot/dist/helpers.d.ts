import type { AddDmRecipientOptions, AddGuildMemberOptions, AddLobbyMember, AtLeastOne, BeginGuildPrune, BigString, Camelize, CreateApplicationCommand, CreateApplicationEmoji, CreateAutoModerationRuleOptions, CreateChannelInvite, CreateForumPostWithMessage, CreateGlobalApplicationCommandOptions, CreateGroupDmOptions, CreateGuildApplicationCommandOptions, CreateGuildBan, CreateGuildBulkBan, CreateGuildChannel, CreateGuildEmoji, CreateGuildRole, CreateGuildSoundboardSound, CreateGuildStickerOptions, CreateLobby, CreateMessageOptions, CreateScheduledEvent, CreateStageInstance, CreateTemplate, CreateTestEntitlement, CreateWebhook, DeleteWebhookMessageOptions, DiscordAccessTokenResponse, DiscordActivityInstance, DiscordApplicationCommandPermissions, DiscordApplicationRoleConnection, DiscordApplicationRoleConnectionMetadata, DiscordAuditLog, DiscordBan, DiscordConnection, DiscordCurrentAuthorization, DiscordFollowedChannel, DiscordGetGatewayBot, DiscordGuildPreview, DiscordGuildWidgetSettings, DiscordInvite, DiscordInviteMetadata, DiscordListArchivedThreads, DiscordPrunedCount, DiscordTokenExchange, DiscordTokenRevocation, DiscordVanityUrl, DiscordVoiceRegion, EditApplication, EditAutoModerationRuleOptions, EditBotMemberOptions, EditChannelPermissionOverridesOptions, EditGuildOnboarding, EditGuildRole, EditGuildStickerOptions, EditMessage, EditOwnVoiceState, EditScheduledEvent, EditUserVoiceState, EditWebhookMessageOptions, ExecuteWebhook, GetApplicationCommandPermissionOptions, GetBans, GetChannelPinsOptions, GetEntitlements, GetGlobalApplicationCommandsOptions, GetGuildApplicationCommandsOptions, GetGuildAuditLog, GetGuildPruneCountQuery, GetInvite, GetMessagesOptions, GetReactions, GetScheduledEvents, GetScheduledEventUsers, GetThreadMember, GetUserGuilds, GetWebhookMessageOptions, InteractionCallbackData, InteractionCallbackOptions, InteractionResponse, LinkChannelToLobby, ListArchivedThreads, ListGuildMembers, ListSkuSubscriptionsOptions, ListThreadMembers, ModifyApplicationEmoji, ModifyChannel, ModifyGuild, ModifyGuildChannelPositions, ModifyGuildEmoji, ModifyGuildMember, ModifyGuildSoundboardSound, ModifyGuildTemplate, ModifyGuildWelcomeScreen, ModifyLobby, ModifyRolePositions, ModifyWebhook, SearchMembers, SendSoundboardSound, StartThreadWithMessage, StartThreadWithoutMessage, UpsertGlobalApplicationCommandOptions, UpsertGuildApplicationCommandOptions } from '@discordeno/types';
import type { Bot } from './bot.js';
import type { DesiredPropertiesBehavior, SetupDesiredProps, TransformersDesiredProperties } from './desiredProperties.js';
import type { ThreadMemberTransformerExtra } from './transformers/threadMember.js';
import type { Application, ApplicationCommand, AutoModerationRule, Channel, Emoji, Entitlement, Guild, GuildApplicationCommandPermissions, GuildOnboarding, GuildWidget, GuildWidgetSettings, Integration, InteractionCallbackResponse, Invite, Lobby, LobbyMember, Member, Message, MessagePin, Role, ScheduledEvent, Sku, SoundboardSound, StageInstance, Sticker, StickerPack, Subscription, Template, ThreadMember, User, VoiceState, Webhook, WelcomeScreen } from './transformers/types.js';
...
export type BotHelpers<TProps extends TransformersDesiredProperties, TBehavior extends DesiredPropertiesBehavior> = {
    ...
    editWebhookMessage: (webhookId: BigString, token: string, messageId: BigString, options: EditWebhookMessageOptions) => Promise<SetupDesiredProps<Message, TProps, TBehavior>>;
    ...
    getChannelPins: (channelId: BigString, options?: GetChannelPinsOptions) => Promise<{
    ...
    createTestEntitlement: (applicationId: BigString, body: CreateTestEntitlement) => Promise<Partial<SetupDesiredProps<Entitlement, TProps, TBehavior>>>;
