...
export declare function createBotHelpers<TProps extends TransformersDesiredProperties, TBehavior extends DesiredPropertiesBehavior>(
...
export type BotHelpers<TProps extends TransformersDesiredProperties, TBehavior extends DesiredPropertiesBehavior> = {
  ...
  getChannelPins: (
    ...
    items: SetupDesiredProps<MessagePin, TProps, TBehavior>[]
    hasMore: boolean
  }>
